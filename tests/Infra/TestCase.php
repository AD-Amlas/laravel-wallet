...
use Bavix\Wallet\Test\Infra\PackageModels\TransferModel;
use Bavix\Wallet\Test\Infra\PackageModels\WalletModel;
...
class TestCase extends OrchestraTestCase
{
    ...
    protected function getPackageProviders($app): array
    {
        ...
        $app['config']->set('wallet.transaction.model', TransactionModel::class);
        $app['config']->set('wallet.transfer.model', TransferModel::class);
        $app['config']->set('wallet.wallet.model', WalletModel::class);
